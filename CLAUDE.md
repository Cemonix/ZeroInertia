...
- **Code Quality**: Ruff (linting), Basedpyright (type checking), Black (formatting)
...
- **Router**: Vue Router
- **Date Handling**: date-fns (formatting & manipulation), chrono-node (natural language date parsing)
...
- Command: `poetry run basedpyright app`
